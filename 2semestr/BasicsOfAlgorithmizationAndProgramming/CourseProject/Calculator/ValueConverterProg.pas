...
begin
  if CurrentChosen = true then
  // Если изменялось значение в поле для исходной величины
  ...
  begin
    ...
    // Првоерка строки на корректность
    begin
      num := strtofloat(bufs);
