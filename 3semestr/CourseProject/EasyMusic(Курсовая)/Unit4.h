...
//---------------------------------------------------------------------------
class TEditPlaylistUnit : public TForm
{
...
public:		// User declarations
	...
	__fastcall TEditPlaylistUnit(TComponent* Owner);
	bool IsImage =  false;
    ...
    bool CheckDirectNames();
};
//---------------------------------------------------------------------------
extern PACKAGE TEditPlaylistUnit *EditPlaylistUnit;
//---------------------------------------------------------------------------
#endif
